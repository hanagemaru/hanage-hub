...
const STAGES=[
 {name:"PHANTOM WAVE",short:"TUTORIAL",desc:"車間を作って渋滞波を吸収",n:22,laps:3,jamLimit:8.5,seed:true,tutorial:true},
...
function render(pre){
  ...
  if(!started){
    ...
    centerSub.textContent=cfg().tutorial?"まずBRAKEを短く押して前に空間を作る":"3周走り切る";
  }
