...
function showModeSelect(){
  ...
  overlay.innerHTML=`<div class="overlayCard"><h2>SELECT MODE</h2><div class="modeMenu"><button id="ch1" class="modeBtn">CHAPTER 1<small>STAGE 1–7 · BASIC</small></button><button id="ch2" class="modeBtn">CHAPTER 2<small>STAGE 8–14 · ADVANCED</small></button><button id="daily" class="modeBtn daily">DAILY CHALLENGE<small>${daily.dateKey} · ${daily.dailyLabel} · ${dr.cleared?"CLEAR":"NEW"}</small></button><button id="endless" class="modeBtn endless">ENDLESS FLOW<small>BEST ${best.toFixed(1)} LAPS · GRIDLOCKまで走る</small></button></div></div>`;
  overlay.classList.remove("hidden");
