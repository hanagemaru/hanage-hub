    ...
    multicolorSweeper: {
      ...
      sections: [
        ...
        },
        {
          ...
          kind: "defs",
          intro:
            "ホーム画面のアイコンから、アプリと同じように開けます。アドレスバーが消えるぶん画面を広く使え、オフラインでも遊べます。",
          items: [
            { term: "iPhone：", body: "共有ボタンから「ホーム画面に追加」を選びます。" },
            { term: "Android：", body: "ブラウザのメニューから「アプリをインストール」を選びます。" },
          ],
          note: "ランキングへの登録にはインターネット接続が必要です。iPhoneでは記録がブラウザと別に保存されるため、追加する前の記録は引き継がれません。",
        },
      ],
    },
    putt: {
      ...
      sections: [
        ...
        },
        {
          ...
          note: "iPhoneでは記録がブラウザと別に保存されるため、追加する前の記録は引き継がれません。",
        },
      ],
    },
  },
