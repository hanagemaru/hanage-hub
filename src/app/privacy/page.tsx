    ...
    <main>
      ...
      <section className="contentSection pageWidth">
        <article className="contentCard">
          ...
          <h3>Cookie・広告</h3>
          <p>
            本ページの最終更新時点で、当サイトおよび掲載作品では広告を配信していません。今後、Google
            AdSenseおよびH5 Games Adsによる広告の導入を予定しています。導入した場合、Googleなどの広告配信事業者がCookie、ウェブビーコン、IPアドレス等を使用し、広告の配信や効果測定、利用者の興味に応じた広告の表示を行うことがあります。
          </p>
          <p>
